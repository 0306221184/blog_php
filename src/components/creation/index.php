...
<main id="auth" class="h-100">
    <form action="./src/features/adminAddUser.php" class="auth-form" method="post" enctype="multipart/form-data">
        <div class="auth-form__input">
            ...
            <input class="myInput" type="text" name="fullName" id="fullName" placeholder="Họ và tên" requiredd>
            <input class="myInput" type="tel" name="phoneNumber" id="phoneNumber" placeholder="Số điện thoại" requiredd>
            <input class="myInput" type="email" name="email" id="email" placeholder="Email" requiredd>
            <input class="myInput" type="text" name="username" id="username" placeholder="Tên đăng nhập" requiredd>
            <input class="myInput" type="password" name="password" id="password" placeholder="Mật khẩu" requiredd>
            <input class="myInput" type="password" name="confirmPassword" id="confirmPassword"
                placeholder="Nhập lại mật khẩu" requiredd>
...
<main id="auth" class="h-100">
    <form action="./src/features/adminAddCategory.php" class="auth-form" method="post">
        <img src="./src/assets/images/spiderum-logo.png" alt="" class="auth-form__logo">
        <div class="auth-form__input">
            <input class="myInput" type="text" name="name" id="name" placeholder="Tên danh mục" required>
            <input class="myInput" type="text" name="description" id="description" placeholder="Mô tả danh mục"
                required>
        </div>
        <?php if (isset($_GET['error'])): ?>
        <p class="text-center text-danger fs-5"><?= $_GET['error'] ?></p>
